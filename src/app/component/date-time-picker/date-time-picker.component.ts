import { Component, OnInit, Input, forwardRef, ViewChild, AfterViewInit, Injector, HostListener, EventEmitter, Output } from '@angular/core';
...
export class DateTimePickerComponent implements ControlValueAccessor, OnInit, AfterViewInit {
    ...
    @HostListener('focusout', ['$event'])
        getClick(e) {
            if (!e.relatedTarget && !(e.target.outerHTML.includes('far,clock')) 
            && !(e.target.outerHTML.includes('fa-calendar')) ) {
                this.onCalendarClose.emit();
            }
        }

    onCalendarClick() {
        this.onCalendarOpen.emit();
    }
